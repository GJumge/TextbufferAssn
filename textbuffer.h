 ...
 * the buffer afterwards. (done)
 */
void releaseTB (TB tb);

/* Allocate and return an array containing the text in the given textbuffer. (done)
 */
char *dumpTB (TB tb);

/* Return the number of lines of the given textbuffer. (done)
 */
int linesTB (TB tb);

/* Swap the two given lines in the textbuffer. (done)
 *
...
/* Merge 'tb2' into 'tb1' at line 'pos'. (done)
 * 
